...
export const info = {
  ...
  about: [
    ...
    "Before my start as a professional software engineer, I enjoyed making automation tools with AutoHotKey and AutoIt, playing around with virtual machines to run old applications, and making static websites. I'm grateful I was able to turn my passion into a rewarding career.",
